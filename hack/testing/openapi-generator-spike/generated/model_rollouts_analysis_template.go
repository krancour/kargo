...
// checks if the RolloutsAnalysisTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RolloutsAnalysisTemplate{}

// RolloutsAnalysisTemplate struct for RolloutsAnalysisTemplate
...
func (o RolloutsAnalysisTemplate) MarshalJSON() ([]byte, error) {
...
func (o RolloutsAnalysisTemplate) ToMap() (map[string]interface{}, error) {
...
type NullableRolloutsAnalysisTemplate struct {
	value *RolloutsAnalysisTemplate
	isSet bool
}

func (v NullableRolloutsAnalysisTemplate) Get() *RolloutsAnalysisTemplate {
	return v.value
}

func (v *NullableRolloutsAnalysisTemplate) Set(val *RolloutsAnalysisTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableRolloutsAnalysisTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableRolloutsAnalysisTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRolloutsAnalysisTemplate(val *RolloutsAnalysisTemplate) *NullableRolloutsAnalysisTemplate {
	return &NullableRolloutsAnalysisTemplate{value: val, isSet: true}
}

func (v NullableRolloutsAnalysisTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRolloutsAnalysisTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
