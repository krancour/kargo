...
// checks if the PromotionTaskList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionTaskList{}

// PromotionTaskList struct for PromotionTaskList
type PromotionTaskList struct {
	...
	Items []PromotionTask `json:"items,omitempty"`
...
// SetItems gets a reference to the given []PromotionTask and assigns it to the Items field.
...
func (o PromotionTaskList) MarshalJSON() ([]byte, error) {
...
func (o PromotionTaskList) ToMap() (map[string]interface{}, error) {
...
type NullablePromotionTaskList struct {
	value *PromotionTaskList
	isSet bool
}

func (v NullablePromotionTaskList) Get() *PromotionTaskList {
	return v.value
}

func (v *NullablePromotionTaskList) Set(val *PromotionTaskList) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionTaskList) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionTaskList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionTaskList(val *PromotionTaskList) *NullablePromotionTaskList {
	return &NullablePromotionTaskList{value: val, isSet: true}
}

func (v NullablePromotionTaskList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionTaskList) UnmarshalJSON(src []byte) error {
	v.isSet = true
