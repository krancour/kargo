...
// V1ConfigMapList struct for V1ConfigMapList
type V1ConfigMapList struct {
	...
	Items []V1ConfigMap `json:"items,omitempty"`
...
// SetItems gets a reference to the given []V1ConfigMap and assigns it to the Items field.
