...
// checks if the RolloutsClusterAnalysisTemplateList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RolloutsClusterAnalysisTemplateList{}

// RolloutsClusterAnalysisTemplateList struct for RolloutsClusterAnalysisTemplateList
type RolloutsClusterAnalysisTemplateList struct {
	...
	Items []RolloutsClusterAnalysisTemplate `json:"items,omitempty"`
...
func NewRolloutsClusterAnalysisTemplateList() *RolloutsClusterAnalysisTemplateList {
	this := RolloutsClusterAnalysisTemplateList{}
	return &this
}
...
func (o *RolloutsClusterAnalysisTemplateList) GetItems() []RolloutsClusterAnalysisTemplate {
	if o == nil || IsNil(o.Items) {
		var ret []RolloutsClusterAnalysisTemplate
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []RolloutsClusterAnalysisTemplate and assigns it to the Items field.
...
func (o RolloutsClusterAnalysisTemplateList) MarshalJSON() ([]byte, error) {
...
func (o RolloutsClusterAnalysisTemplateList) ToMap() (map[string]interface{}, error) {
...
type NullableRolloutsClusterAnalysisTemplateList struct {
	value *RolloutsClusterAnalysisTemplateList
	isSet bool
}

func (v NullableRolloutsClusterAnalysisTemplateList) Get() *RolloutsClusterAnalysisTemplateList {
	return v.value
}

func (v *NullableRolloutsClusterAnalysisTemplateList) Set(val *RolloutsClusterAnalysisTemplateList) {
	v.value = val
	v.isSet = true
}

func (v NullableRolloutsClusterAnalysisTemplateList) IsSet() bool {
	return v.isSet
}

func (v *NullableRolloutsClusterAnalysisTemplateList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRolloutsClusterAnalysisTemplateList(val *RolloutsClusterAnalysisTemplateList) *NullableRolloutsClusterAnalysisTemplateList {
	return &NullableRolloutsClusterAnalysisTemplateList{value: val, isSet: true}
}

func (v NullableRolloutsClusterAnalysisTemplateList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRolloutsClusterAnalysisTemplateList) UnmarshalJSON(src []byte) error {
	v.isSet = true
