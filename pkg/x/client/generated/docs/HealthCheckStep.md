...
------------ | ------------- | ------------- | -------------
**Config** | Pointer to [**any**](any.md) | Config is the configuration for the directive. | [optional] 
...
`func (o *HealthCheckStep) GetConfig() any`

GetConfig returns the Config field if non-nil, zero value otherwise.

### GetConfigOk

`func (o *HealthCheckStep) GetConfigOk() (*any, bool)`
...
`func (o *HealthCheckStep) SetConfig(v any)`
