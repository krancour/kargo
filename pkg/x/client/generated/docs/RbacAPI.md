...
func main() {
	project := "project_example" // string | Project name
	body := any{ ... } // any | Role resource (github.com/akuity/kargo/api/rbac/v1alpha1.Role)
 ...
 **body** | **any** | Role resource (github.com/akuity/kargo/api/rbac/v1alpha1.Role) | 
...
> any GetProjectRole(ctx, project, role).Execute()
...
func main() {
	...
	// response from `GetProjectRole`: any
...
> any GetSystemRole(ctx, role).Execute()
...
func main() {
	...
	// response from `GetSystemRole`: any
...
> any ListProjectRoles(ctx, project).Execute()
...
func main() {
	...
	// response from `ListProjectRoles`: any
...
> any ListSystemRoles(ctx).Execute()
...
func main() {
	...
	// response from `ListSystemRoles`: any
