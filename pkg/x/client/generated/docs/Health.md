...
------------ | ------------- | ------------- | -------------
**Config** | Pointer to [**any**](any.md) | Config is the opaque configuration of all health checks performed on this Stage. | [optional] 
...
**Output** | Pointer to [**any**](any.md) | Output is the opaque output of all health checks performed on this Stage. | [optional] 
