...
`func (o *CreateResourceResult) GetCreatedResourceManifest() map[string]any`
...
`func (o *CreateResourceResult) GetCreatedResourceManifestOk() (*map[string]any, bool)`
...
`func (o *CreateResourceResult) SetCreatedResourceManifest(v map[string]any)`
