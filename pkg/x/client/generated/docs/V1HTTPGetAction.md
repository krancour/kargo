...
**Port** | Pointer to [**any**](any.md) | Name or number of the port to access on the container. Number must be in the range 1 to 65535. Name must be an IANA_SVC_NAME. | [optional] 
...
`func (o *V1HTTPGetAction) GetPort() any`

GetPort returns the Port field if non-nil, zero value otherwise.

### GetPortOk

`func (o *V1HTTPGetAction) GetPortOk() (*any, bool)`
...
`func (o *V1HTTPGetAction) SetPort(v any)`
